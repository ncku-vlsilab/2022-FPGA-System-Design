...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set bram_busy [ create_bd_port -dir O bram_busy ]
  ...
  connect_bd_net -net blk_mem_gen_0_rsta_busy [get_bd_ports bram_busy] [get_bd_pins blk_mem_gen_0/rsta_busy]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
