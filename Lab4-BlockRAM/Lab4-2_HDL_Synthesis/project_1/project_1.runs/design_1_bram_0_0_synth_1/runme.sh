...
HD_PWD='D:/2021-FPGA-System-Design/Lab4-BlockRAM/Lab4-2_HDL_Synthesis/project_1/project_1.runs/design_1_bram_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bram_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bram_0_0.tcl
