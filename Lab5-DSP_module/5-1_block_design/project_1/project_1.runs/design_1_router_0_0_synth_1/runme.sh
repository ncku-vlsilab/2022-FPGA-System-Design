...
HD_PWD='D:/2021-FPGA-offline/Lab5-DSP module/5-1 block design/project_1/project_1.runs/design_1_router_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_router_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_router_0_0.tcl
