...
proc create_root_design { parentCell } {
  ...
  set block_name router
  set block_cell_name router_0
  if { [catch {set router_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins router_0/din]
  connect_bd_net -net dsp_macro_0_P [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins dsp_macro_0/P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins dsp_macro_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net router_0_A [get_bd_pins dsp_macro_0/A] [get_bd_pins router_0/A]
  connect_bd_net -net router_0_B [get_bd_pins dsp_macro_0/B] [get_bd_pins router_0/B]
