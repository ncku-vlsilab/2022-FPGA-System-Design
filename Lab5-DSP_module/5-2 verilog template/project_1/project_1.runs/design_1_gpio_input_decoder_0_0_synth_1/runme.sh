...
HD_PWD='D:/2021-FPGA-System-Design/Lab5-DSP_module/5-2 verilog template/project_1/project_1.runs/design_1_gpio_input_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_gpio_input_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_gpio_input_decoder_0_0.tcl
